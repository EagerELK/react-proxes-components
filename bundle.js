...
},{"./lib/ReactPropTypesSecret":33,"fbjs/lib/invariant":35,"fbjs/lib/warning":36}],30:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./checkPropTypes":29,"./lib/ReactPropTypesSecret":33,"fbjs/lib/emptyFunction":34,"fbjs/lib/invariant":35,"fbjs/lib/warning":36,"object-assign":37}],32:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./emptyFunction":34}],37:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./es-panel":43,"numeral":27,"prop-types":32,"react":undefined}],40:[function(require,module,exports){
'use strict';
...
},{"./big-number":39,"react":undefined}],41:[function(require,module,exports){
'use strict';
...
},{"./es-panel":43,"numeral":27,"react":undefined}],42:[function(require,module,exports){
'use strict';
...
},{"axios":1,"prop-types":32,"react":undefined}],43:[function(require,module,exports){
'use strict';
...
},{"./es-store":44,"./update-footer":55,"react":undefined}],44:[function(require,module,exports){
'use strict';
...
},{"./timeAgo":52,"axios":1}],45:[function(require,module,exports){
'use strict';
...
var ESTable = (function (_ESPanel) {
  ...
  _createClass(ESTable, [{
    ...
    value: function compareRows(a, b) {
      ...
      var result = (0, _stringNaturalCompare2['default'])(a, b);
    ...
    value: function findRow(row) {
      ...
      return this.props.children.some(function (column) {
        var value = _this.getDescendantProp(row, column.props.source);
    ...
    value: function getBody() {
      ...
      var rows = this.getRows().filter(this.findRow.bind(this)).sort(this.compareRows.bind(this));
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: 'panel-body' },
          _react2['default'].createElement('input', { type: 'search', className: 'search form-control', placeholder: 'Start typing to filter', onChange: this.filterRows.bind(this) })
        ),
        _react2['default'].createElement(
          'table',
          { className: 'table' },
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              this.props.children.map(function (column) {
                return _react2['default'].createElement(
                  'th',
                  { key: column.props.source, role: 'button', onClick: _this2.sortBy.bind(_this2), 'data-sort': column.props.source },
                  _this2.columnHeader(column),
                  ' ',
    ...
    key: 'filterRows',
    value: function filterRows(event) {
...
},{"./es-panel":43,"moment":26,"numeral":27,"react":undefined,"string-natural-compare":38}],46:[function(require,module,exports){
'use strict';
...
},{"./es-panel":43,"react":undefined}],47:[function(require,module,exports){
'use strict';
...
var IndexList = (function (_ESTable) {
  _inherits(IndexList, _ESTable);
...
},{"./es-table":45,"./update-footer":55,"numeral":27,"react":undefined}],48:[function(require,module,exports){
'use strict';
...
},{"./es-table":45,"react":undefined}],49:[function(require,module,exports){
'use strict';
...
},{"./es-table":45,"react":undefined}],50:[function(require,module,exports){
'use strict';
...
},{"./es-panel":43,"numeral":27,"react":undefined}],51:[function(require,module,exports){
'use strict';
...
TableColumn.propTypes = {
	...
	format: _propTypes2['default'].oneOf(['date', 'size', 'number', 'string'])
};
...
},{"prop-types":32,"react":undefined}],52:[function(require,module,exports){
"use strict";

function timeAgo(originalTime) {
    var templates = {
        prefix: "",
        suffix: " ago",
        lessthantensecs: "seconds",
    ...
    var timer = function timer(time) {
        ...
        return templates.prefix + (seconds < 11 && template('lessthantensecs', seconds) || seconds < 45 && template('seconds', seconds) || seconds < 90 && template('minute', 1) || minutes < 45 && template('minutes', minutes) || minutes < 90 && template('hour', 1) || hours < 24 && template('hours', hours) || hours < 42 && template('day', 1) || days < 30 && template('days', days) || days < 45 && template('month', 1) || days < 365 && template('months', days / 30) || years < 1.5 && template('year', 1) || template('years', years)) + templates.suffix;
    };

    return timer(originalTime);
}
...
var TotalClusterMemory = (function (_BigNumber) {
  _inherits(TotalClusterMemory, _BigNumber);

  function TotalClusterMemory() {
    _classCallCheck(this, TotalClusterMemory);

    _get(Object.getPrototypeOf(TotalClusterMemory.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(TotalClusterMemory, [{
    key: 'getHeading',
    value: function getHeading() {
      var icon = this.state.data.status == 'unknown' ? 'fa fa-question' : 'fa fa-folder';
      return _react2['default'].createElement(
...
exports['default'] = TotalClusterMemory;
module.exports = exports['default'];

},{"./big-number":39,"react":undefined}],54:[function(require,module,exports){
'use strict';
...
},{"./big-number":39,"react":undefined}],55:[function(require,module,exports){
'use strict';
...
},{"./timeAgo":52,"react":undefined}],56:[function(require,module,exports){
'use strict';
...
var UsedClusterMemory = (function (_BigNumber) {
  _inherits(UsedClusterMemory, _BigNumber);

  function UsedClusterMemory() {
    _classCallCheck(this, UsedClusterMemory);

    _get(Object.getPrototypeOf(UsedClusterMemory.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(UsedClusterMemory, [{
    key: 'getHeading',
    value: function getHeading() {
      var icon = this.state.data.status == 'unknown' ? 'fa fa-question' : 'fa fa-folder';
      return _react2['default'].createElement(
...
exports['default'] = UsedClusterMemory;
module.exports = exports['default'];

},{"./big-number":39,"react":undefined}],57:[function(require,module,exports){
'use strict';
...
var UsedOSMemory = (function (_BigNumber) {
  _inherits(UsedOSMemory, _BigNumber);

  function UsedOSMemory() {
    _classCallCheck(this, UsedOSMemory);

    _get(Object.getPrototypeOf(UsedOSMemory.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(UsedOSMemory, [{
    key: 'getHeading',
    value: function getHeading() {
      var icon = this.state.data.status == 'unknown' ? 'fa fa-question' : 'fa fa-folder';
      return _react2['default'].createElement(
...
exports['default'] = UsedOSMemory;
module.exports = exports['default'];

},{"./big-number":39,"react":undefined}],"react-proxes-components":[function(require,module,exports){
'use strict';
...
},{"./big-number":39,"./cluster-available-space":40,"./documents":41,"./elasticsearch-call":42,"./es-store":44,"./es-table":45,"./health":46,"./index-list":47,"./node-detail":48,"./node-info":49,"./storage":50,"./table-column":51,"./total-cluster-memory":53,"./total-os-memory":54,"./update-footer":55,"./used-cluster-memory":56,"./used-os-memory":57,"react":undefined}]},{},[]);
