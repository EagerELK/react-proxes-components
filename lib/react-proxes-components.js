...
var _clusterMemory = require('./cluster-memory');

var _clusterMemory2 = _interopRequireDefault(_clusterMemory);

var _osMemory = require('./os-memory');

var _osMemory2 = _interopRequireDefault(_osMemory);

var _indexingRate = require('./indexing-rate');

var _indexingRate2 = _interopRequireDefault(_indexingRate);
...
var ProxesComponents = (function (_React$Component) {
  ...
  _createClass(ProxesComponents, [{
    ...
    value: function render() {
      var store = new _esStore2['default'](this.props.pollInterval);
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_health2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          ),
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_storage2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          ),
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_documents2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          )
        ),
        _react2['default'].createElement(
          'div',
          ...
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_clusterAvailableSpace2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          ),
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_clusterMemory2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          ),
          _react2['default'].createElement(
            'div',
            { className: 'col-md-4' },
            _react2['default'].createElement(_osMemory2['default'], { store: store, elasticsearch_url: this.props.elasticsearch_url })
          )
        ),
        _react2['default'].createElement(
          'div',
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _nodeInfo2['default'],
              { store: store, elasticsearch_url: this.props.elasticsearch_url },
...
exports.ClusterMemory = _clusterMemory2['default'];
exports.OSMemory = _osMemory2['default'];
